...
import json
import re
def extract_sections_by_font(pdf_path, heading_font_threshold=25, space_threshold=1.5):
    """
    ...
    with pdfplumber.open(pdf_path) as pdf:
        for i , page in enumerate(pdf.pages):
            ...
            for line_chars in sorted_lines:
                ...
                print(avg_font_size , heading_font_threshold)
                print(avg_font_size > heading_font_threshold)
                print('\n')
...
sections = extract_sections_by_font(pdf_path, heading_font_threshold=25, space_threshold=1.5)
